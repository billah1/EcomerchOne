<aside class="left-sidebar">
    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                <li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><img src="{{asset('/')}}backend/dist/images/users/1.jpg" alt="user-img" class="img-circle"><span class="hide-menu">Mark Jeckson</span></a>
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Dashboard <span class="badge rounded-pill bg-cyan ms-auto">4</span></span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="#categories"data-href="">
                        ...
                        <li><a href="#subcategories" data-href="">
                                <i data-cs-icon="cupcake" class="icon" data-cs-size="18"></i>
                                SubCategories
                            </a>
                            <ul id="subcategories">
                        ...
                        <li><a href="#childcategories" data-href="">
                                <i data-cs-icon="cupcake" class="icon" data-cs-size="18"></i>
                                ChildCategories</a>
